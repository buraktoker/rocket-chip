...
object PositDivSqrtDriver extends App {
    //chisel3.Driver.execute(args, () => new PositDivSqrt(32,2))
     (new chisel3.stage.ChiselStage).emitVerilog(new PositDivSqrt(32,2), Array("--target-dir", "generated"))
}
